...
#LAN_OR_WIFI_SERVER_IP='192.168.1.1'     #54 models, brands: 2Wire,3Com,Actiontec,Airlink,Asus,Aztech,Belkin,Billion,Buffalo,Cisco,Dell,D-Link,Eminent,Gigabyte,Hawking,Huawei,Linksys,Motorola,MSI,NetComm,Netopia,Planet,Repotec,Siemens,Sitecom,SMC Networks,SpeedTouch,Synology,Tenda,Thomson,TP-Link,Trendnet,U.S. Robotics,Ubiquiti,Zoom,ZTE,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.0.1'     #35 models, brands: 2Wire,Actiontec,Card King,Cisco,D-Link,Eero,Eminent,Google,Huawei,LevelOne,Linksys,Motorola,Netgear,Netopia,Planet,Senao,Siemens,Sitecom,SMC Networks,Sonicwall,Tenda,Thomson,TP-Link,Trendnet,ZTE,Zyxel
#LAN_OR_WIFI_SERVER_IP='10.0.0.2'        #19 models, brands: 2Wire,Asus,Belkin,Billion,Cisco,D-Link,Huawei,NetComm,Siemens,Sitecom,SMC Networks,SpeedTouch,Zoom,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.2.1'     #18 models, brands: Actiontec,Airlink,Airlive,Airties,Asus,Aztech,Belkin,Edimax,Linksys,Microsoft,Siemens,SMC Networks,Trendnet,U.S. Robotics,Zoom,ZTE,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.10.1'    # 8 models, brands: Motorola,NetComm,Repotec,Trendnet,Zoom,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.254.254' # 5 models, brands: Actiontec,Aztech,D-Link,Siemens,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.15.1'    # 4 models, brands: D-Link,Linksys,Motorola,Sweex
#LAN_OR_WIFI_SERVER_IP='192.168.123.254' # 4 models, brands: LevelOne,Repotec,Sitecom,U.S. Robotics
#LAN_OR_WIFI_SERVER_IP='192.168.100.1'   # 4 models, brands: Huawei,Motorola,Thomson,ZTE
#LAN_OR_WIFI_SERVER_IP='10.1.1.1'        # 2 models, brands: Belkin,D-Link
#LAN_OR_WIFI_SERVER_IP='192.168.8.1'     # 2 models, brands: Eminent,Huawei
#LAN_OR_WIFI_SERVER_IP='192.168.4.1'     # 2 models, brands: Zoom,Zyxel
#LAN_OR_WIFI_SERVER_IP='192.168.3.1'     # 2 models, brands: Amped Wireless,Huawei
#LAN_OR_WIFI_SERVER_IP='192.168.20.1'    # 2 models, brands: Motorola,NetComm
#LAN_OR_WIFI_SERVER_IP='192.168.16.1'    # 2 models, brands: Linksys,Repotec
#LAN_OR_WIFI_SERVER_IP='10.0.1.1'        # 1 models, brands: Apple
#LAN_OR_WIFI_SERVER_IP='10.1.10.1'       # 1 models, brands: SMC Networks
#LAN_OR_WIFI_SERVER_IP='10.10.1.1'       # 1 models, brands: Asus
#LAN_OR_WIFI_SERVER_IP='10.90.90.90'     # 1 models, brands: D-Link
#LAN_OR_WIFI_SERVER_IP='192.168.102.1'   # 1 models, brands: Motorola
#LAN_OR_WIFI_SERVER_IP='192.168.11.1'    # 1 models, brands: Buffalo
#LAN_OR_WIFI_SERVER_IP='192.168.168.168' # 1 models, brands: Sonicwall
#LAN_OR_WIFI_SERVER_IP='192.168.223.100' # 1 models, brands: Trendnet
#LAN_OR_WIFI_SERVER_IP='192.168.251.1'   # 1 models, brands: Sweex
#LAN_OR_WIFI_SERVER_IP='192.168.30.1'    # 1 models, brands: Motorola
#LAN_OR_WIFI_SERVER_IP='192.168.50.1'    # 1 models, brands: Sweex
#LAN_OR_WIFI_SERVER_IP='192.168.55.1'    # 1 models, brands: Sweex
#LAN_OR_WIFI_SERVER_IP='192.168.62.1'    # 1 models, brands: Motorola
#LAN_OR_WIFI_SERVER_IP='192.168.86.1'    # 1 models, brands: Google
#LAN_OR_WIFI_SERVER_IP='200.200.200.5'   # 1 models, brands: Trendnet
